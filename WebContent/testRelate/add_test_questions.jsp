...
*****************************************************************
<form:form action="moveQuestions" modelAttribute="addQuestionParams" class="form-inline" style="width: 85%;margin-left: 7%;margin-top: 40px;">

     <div class="form-group"  style="width: 20%">
	    <label  for="exampleInputName2">章节数</label>
	 	<form:input path="sectionNum" type="text" class="form-control" id="exampleInputName2" />
	 	<form:hidden path="testPaperId" class="form-control" id="exampleInputName2" />
	  </div>
	  <br><br>
	  <div class="form-group" style="width: 15%;margin-left: 10%">
	    <label for="exampleInputName2">简单题</label>
	    <input type="hidden" class="form-control" id="exampleInputName2" />
	  </div>
	  <div class="form-group" style="width: 15%">
	    <label for="exampleInputName2">中等题</label>
	 	<input type="hidden" class="form-control" id="exampleInputName2" />
	  </div>
	  <div class="form-group" style="width: 15%">
	    <label for="exampleInputEmail2">难题</label>
	 	<input type="hidden" class="form-control" id="exampleInputName2" />
	  </div>
	  <br><br>
	  <div class="form-group" style="width: 85%">
	    <label for="exampleInputName2">选择数目</label>
	 	<form:input path="easyChoice" type="text" class="form-control" id="exampleInputName2" />
	 	<form:input path="normalChoice" type="text" class="form-control" id="exampleInputName2" />
	    <form:input path="hardChoice" type="text" class="form-control" id="exampleInputName2" />
	    <input type="hidden" class="form-control" id="exampleInputName2" />

	    <label for="exampleInputName2">总数目</label>
	  ...
	  <div class="form-group" style="width: 85%">
	    <label for="exampleInputEmail2">填空数目</label>
	 	<form:input path="easyfill" type="text" class="form-control" id="exampleInputName2" />
	    <form:input path="normalfill" type="text" class="form-control" id="exampleInputName2" />
	    <form:input path="hardfill" type="text" class="form-control" id="exampleInputName2" />
	    <input type="hidden" class="form-control" id="exampleInputName2" />
	  ...
	  <div class="form-group" style="width: 85%">
	    <label for="exampleInputName2">判断数目</label>
	 	<form:input path="easyTF" type="text" class="form-control" id="exampleInputName2" />
	    <form:input path="normalTF" type="text" class="form-control" id="exampleInputName2" />
	    <form:input path="hardTF" type="text" class="form-control" id="exampleInputName2" />
	    <input type="hidden" class="form-control" id="exampleInputName2" />
	  ...
	  <div class="form-group" style="width: 85%">
	    ...
	    <form:input path="easyComprehensive" type="text" class="form-control" id="exampleInputName2" />
	    <form:input path="normalComprehensive" type="text" class="form-control" id="exampleInputName2" />
	    <form:input path="hardComprehensive" type="text" class="form-control" id="exampleInputName2" />
	    <input type="hidden" class="form-control" id="exampleInputName2" />
	  ...
	  <button type="button" onclick="tip()" class="btn btn-default">添加</button> 
  	  <a href="getTestPaperInfos"><button type="button" class="btn btn-default">完成</button></a>
