  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>试卷管理</h1>
        <p>添加或者修改选中的试卷，删除功能暂不开放。</p>
        <div class="page_nav">
      <span>当前位置:</span> <a href="index.html">测试管理</a> <span><i class="fa fa-angle-double-right"></i>试卷管理</span>
      </div>
      </div>
    </div>
  </div>
...
<table class="table table-hover" style="margin-top:80px;width: 80%;margin-left: 3.5%;">
	...
	<c:forEach items="${requestScope.testPaperList }" var="testPaper">
		<tr>
			...
			<td><a href="editTestPaper?paperId=${testPaper.testPaperInfoId }">
				<input class="btn btn-default btn-xs" type="button" name="button" value="编辑考试信息">
				</a>
			</td>
		</tr>
	</c:forEach>
