  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>选择试题编辑</h1>
        <p>添加或者修改选中的题目，删除功能暂不开放。</p>
        <div class="page_nav">
      <span>当前位置:</span> <a href="index.html">题库管理</a> <span><i class="fa fa-angle-double-right"></i>选择试题编辑</span>
      </div>
      </div>
    </div>
  </div>
...
<!-- 	<img src="" alt="../images/banner1.jpg" data-bgposition="center center" data-bgfit="cover" data-bgparallax="10" class="rev-slidebg">							
 -->	
	...
	<table id="tooltab" title="选择试题" style="width:98%;height:350px"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'optionC',width:250">选项C</th>
...
<div style="margin-left: 5%">
	<form id="editForm" action="#" class="form-inline" style="visibility: hidden;">
	  <div class="form-group">
	    <label for="exampleInputName2">题干</label>
	    <input type="text" class="form-control" id="topic" >
	  </div>
	  <div class="form-group">
	    <label for="exampleInputEmail2">选项A</label>
	    <input type="text" class="form-control" id="optionA" >
	  </div>
	  <div class="form-group">
	    <label for="exampleInputEmail2">选项B</label>
	    <input type="text" class="form-control" id="optionB" >
	  </div>
	  <div class="form-group">
	    <label for="exampleInputEmail2">选项C</label>
	    <input type="text" class="form-control" id="optionC" >
	  </div>
	  <div class="form-group">
	    <label for="exampleInputEmail2">选项D</label>
	    <input type="text" class="form-control" id="optionD" >
	  </div>
	  <div class="form-group">
	    <label for="exampleInputEmail2">答案</label>
	    <input type="text" class="form-control" id="answer" >
	  </div>
	  <div class="form-group">
	    <label for="exampleInputEmail2">解析</label>
	    <input type="text" class="form-control" id="analysis" >
	  </div>
	  <div class="form-group">
	    <label for="exampleInputEmail2">所属章节</label>
	  ...
	  <br><br>
	  <button type="button" onclick="hid()" class="btn btn-default">提交</button>
	</form>
	</div>
