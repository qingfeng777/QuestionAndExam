  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>操作日志</h1>
        <p>可以在此处查看对档案的一切操作，以保证公平公正</p>
        <div class="page_nav">
      <span>当前位置:</span> <a href="#">日志</a> <span><i class="fa fa-angle-double-right"></i>日志查询</span>
      </div>
      </div>
    </div>
  </div>
...
<div style="height:450px;">
	<form action="show" method="get" style="margin-top:80px;width: 80%;margin-left: 5.5%;">
	    <input name="search" type="search" value="" placeholder="试卷编号"  />
	    <input name="userId" type="search" value="" placeholder="日期：yyyy-mm-dd"  />
...
<table class="table table-hover" style="margin-top:80px;width: 80%;margin-left: 3.5%;">
	...
	<c:forEach items="${requestScope.fileList }" var="testPaper">
		<tr>
			...
			<td>${testPaper.fileId }</td>
			<td>${testPaper.odata }</td>
			<td>${testPaper.operateUser }</td>
			<td>查看</td>
