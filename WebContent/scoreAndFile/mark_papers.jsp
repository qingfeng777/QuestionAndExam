...
<div style="height:450px;">
	<form action="mark" method="get" style="margin-top:80px;width: 80%;margin-left: 5.5%;">
	    <input name="search" type="search" value="" placeholder="试卷编号"  required/>
	...
	<c:forEach items="${requestScope.fileList }" var="testPaper">
		<tr>
			...
			<%-- <td><a href="toEditTestPaper?paperId=${testPaper.testPaperInfoId }">
			 ...
			 <td><a href="markPaper?paperId=${testPaper.fileInfoId }">
				<input class="btn btn-default btn-xs" type="button" name="button" value="批改">
				</a>
			</td> 
		</tr>
	</c:forEach>
