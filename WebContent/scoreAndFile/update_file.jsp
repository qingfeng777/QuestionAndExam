...
<div style="margin-left: 5%">
	<h1 style="margin-top: 20px;margin-left: 37%">档案更正</h1>
	<h1 style="margin-top: 20px;margin-left: 35%">所有操作均会存档，请慎重</h1>
	<h2 style="margin-top: 20px;margin-left: 7%">填空题：</h2>
	<br><br><br>
	<c:forEach items="${requestScope.fillList}" var="Sto" varStatus="status">
	<h3>第${status.index+1}题(2分)</h4><br>
		<form:form class="form-inline"  action="addUser" method="post" modelAttribute="fill">
			...
			<br><br>
			<form:input  class="form-control" path="score"  name="score" placeholder="从新评分？" />
...
<div style="margin-left: 5%">
	...
	<h3>第${status.index+1}题,(共10分 )</h4><br>
		<form:form class="form-inline"  action="upFileAction" method="post" modelAttribute="comprehensive">
			<form:hidden   path="filePaperComprehensiveId" name="filePaperComprehensiveId" value="${Sto.filePaperComprehensiveId }" />
			...
			<form:input  class="form-control input-lg" path="score" name="score" placeholder="从新评分？" />
...
<!-- 		<input class="btn btn-default" type="button" value="编辑信息" onclick="edit()">
 -->		<a href="filesUpdate"><input class="btn btn-default" type="button" value="完成" ></a>
	</div>
<!-- ***********************************页脚************************************** -->
