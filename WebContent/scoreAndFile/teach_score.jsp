  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        ...
        <p>查看已考试的考试得分等信息</p>
        <div class="page_nav">
      <span>当前位置:</span> <a href="index.html">测试</a> <span><i class="fa fa-angle-double-right"></i>分数查询</span>
      </div>
      </div>
    </div>
  </div>
...
<div style="height:450px;">
	<form action="searchScore" method="get" style="margin-top:80px;width: 80%;margin-left: 5.5%;">
	    <input name="search" type="search" value="" placeholder="学号"  />
	    <input name="subject" type="search" value="" placeholder="科目"  />
	    <input name="class 	" type="search" value="" placeholder="班级"  />
	    <br><br><br><br>
	    <button style="margin-left: 55%" type="submit" class="btn btn_common blue">查询</button>
	  </form>
	  <br>
