...
<div style="height:450px;">
	<form action="studentSearchScore" method="get" style="margin-top:80px;width: 80%;margin-left: 5.5%;">
	    <input name="search" type="search" value="" placeholder="学号"  required/>
